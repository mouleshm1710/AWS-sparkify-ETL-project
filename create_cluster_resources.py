...
print("Connection to the AWS services is successfull ")
print()


# Create IAM Redshift Role & attach policies

print("Lets Delete Existing IAM role: ")
try:
...
print("Lets Create a new IAM role: ")
try:
...
print("Lets Delete any existing cluster: ")
try:
    redshift.delete_cluster(ClusterIdentifier=DWH_CLUSTER_IDENTIFIER,  SkipFinalClusterSnapshot=True)
    print("cluster deleted initiated...")
    print()
...
# Write the endpoint & vpcID back to the config file
