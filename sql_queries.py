# importing datawarehouse credentials
import configparser
...
## Staging tables:-
staging_songs_table_create= ("""CREATE TABLE stagingsongs (num_songs INT,artist_id VARCHAR(255),artist_latitude FLOAT,\
artist_longitude FLOAT,artist_location VARCHAR(255),artist_name VARCHAR(255),song_id VARCHAR(255),title VARCHAR(255),\
duration FLOAT,year INT)""")

staging_events_table_create = (""" CREATE TABLE stagingevents (\
artist VARCHAR(255),\
auth VARCHAR(255),\
...
JOIN stagingsongs s ON e.song = s.title AND e.artist = s.artist_name and  e.length = s.duration \
